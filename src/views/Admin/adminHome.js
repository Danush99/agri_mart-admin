...
export function AdminHome() {
    ...
    useEffect( ()=> {
        AdminServices.getAdmin(adminID)
        .then((admin)=>{
            setadminDetails(admin[0]);
...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <Link state={{admin:adminDetails}} to="/admin/register">
            <li class="nav-item">
                <a class="nav-link">
            ...
            <Link state={{admin:adminDetails}} to="/admin/manageOffficers">
            <li class="nav-item">
                <a class="nav-link">
            ...
            <Link state={{admin:adminDetails}} to="/admin/addfiles">
            <li class="nav-item">
                <a class="nav-link">
                    <i class="fas fa-fw fa-file-import"></i>
                    <span>Add Agricultural Data</span>
                </a>
            </li>
            </Link>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                {/* Header */}
                {/* <Header userDetails={adminDetails}/> */}
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div>{adminDetails.firstname} {adminDetails.lastname}</div>
                        <div><span class="badge rounded-pill bg-info text-dark">Admin</span></div>
                        </span>
